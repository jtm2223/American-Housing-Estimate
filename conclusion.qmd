...
insights. Going forward for future research we could include integrating more 
of a dynamically growing data set and more outside social economic data. 
This is so we are not just assuming from inference but actual data when 
explaining trends that are found. Overall, we learned that we were able to gain 
meaningful analysis from combining cleaning techniques and different 
visualizations techniques. More specifically, we learned about just how volatile 
and complicated the housing market really is.
