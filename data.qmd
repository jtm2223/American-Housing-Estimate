...
ggplot(missing_summary, aes(x = reorder(Column, -MissingPercentage), y = MissingPercentage)) +
  ...
  theme(
    ...
    plot.margin = margin(60, 20, 60, 20)
  )

ggsave("missing_values_plot_fixed.png", width = 12, height = 9)
```
This graph shows tha the majority of the columns are fully complete, with no 
missing values at all. "Median_Contract_Rent" is one of the few columns with a 
small percentage of missing data (0.2%). Overall the dataset is highly reliable 
overall, with minimal data loss.