...
```
This graph was created to see which 10 states within the country had the highest 
disparity between owners and renter percentage. We ordered the ten states from 
those with the highest differences between owners and renters to those with the 
lowest. As we see here states like Florida and Texas the difference is the 
biggest and is a buyer heavy market maybe due to lower housing costs and better 
market.